...
const formatBeijingDate = (instant) => {
 ...
 */
export const toBeijingDate = (value) => {
    if (value === undefined)
        return undefined;
...
export const todayInBeijing = () => formatBeijingDate(new Date());
/**
 ...
 */
export const nextBeijingDay = (day) => {
 ...
 */
export const beijingDayGap = (from, to) => {
